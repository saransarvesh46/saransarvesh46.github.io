...
const ScrollStack = ({
  ...
  const setupScrollLoop = useCallback(() => {
    if (useWindowScroll) {
      // For window scroll, a continuous RAF loop is incredibly smooth
      // because it guarantees the transform matches the exact scroll position before every paint.
      const loop = () => {
        updateCardTransforms();
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner px-4 md:px-0 pb-[30rem]">
        {children}
